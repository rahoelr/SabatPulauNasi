        ...
        <div class="section-content section-dashboard-home" data-aos="fade-up">
            <div class="container">
                ...
                <form action="{{ route('admin-teams.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="content">
                        <div class="kiri">
                            <label for="file-input"><input type="file"
                                    class="form-control 
                        @error('images')
                            is-invalid
                        @enderror"
                                    id="input-file" name="images" accept="image/*" onchange="previewImage()"><i
                    ...
                    @enderror"
                                    ...
                                    <option value='Sekretaris 1'
                                        {{ old('position') === 'Sekretaris 1' ? 'selected' : '' }}>
                                        Sekretaris 1</option>
                                    <option value='Sekretaris 2'
                                        {{ old('position') === 'Sekretaris 2' ? 'selected' : '' }}>
                                        Sekretaris 2</option>
                                    ...
                                    <option value='Dokumentasi'
                                        {{ old('position') === 'Dokumentasi' ? 'selected' : '' }}>Dokumentasi</option>
                                </select>
                                @error('position')
                                    <div class="invalid-feedback ml-4">
                                        {{ $message }}
